                    ...
                    children: [
                      Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              CustomText(
                                  text: 'Eat food', size: 34, fontWeight: FontWeight.w600),
                              CustomText(
                                  text: 'that is healthy', size: 34, fontWeight: FontWeight.w600),
                              CustomText(text: 'for you', size: 34, fontWeight: FontWeight.w600),
                              SizedBox(height: 20,),
                        ...
                        decoration: BoxDecoration(
                          // color: Colors.red,
                            image: DecorationImage(
                                image: AssetImage('assets/imgs/pg2.png')
                            )
                        ),
                      ),
                    ))
